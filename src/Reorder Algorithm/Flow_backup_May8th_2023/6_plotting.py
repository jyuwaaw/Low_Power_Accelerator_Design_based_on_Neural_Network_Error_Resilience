...
data3 = pd.read_table(r'7.3x3Array\4_Delay\seq1_Delay.txt')
...
plt.plot(data2, linewidth=2.0, linestyle='-.', color='blue', label='OriginalDelay')
plt.plot(data3, linewidth=2.0, linestyle='-', color=(0.718, 0.133, 0.188), label='PE[0,0]')
plt.legend()
